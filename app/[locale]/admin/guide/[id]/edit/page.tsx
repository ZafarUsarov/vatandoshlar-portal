...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title:
      locale === "de"
        ? "Guide-Artikel bearbeiten"
        : "Guide maqolasini tahrirlash",
    robots: {
      index: false,
      follow: false,
    },
...
const copy = {
  uz: {
    ...
    title:
      "Guide maqolasini tahrirlash",
    description:
      "PostgreSQL’dagi mavjud Guide maqolasining UZ/DE kontenti, strukturalari, manbalari va tekshiruv sanasini yangilang.",
    back:
  ...
  de: {
    ...
    title:
      "Guide-Artikel bearbeiten",
    description:
      "Bearbeiten Sie UZ/DE-Inhalte, strukturierte Daten, Quellen und Prüfdatum des vorhandenen PostgreSQL-Guide-Artikels.",
    back:
...
export default async function AdminGuideEditPage({
  ...
  const article =
    await getAdminGuideArticleById(
      id,
    );
