    ...
    locale === "de"
      ? {
          ...
          title:
            "Ihr Konto ist aktiv",
          description:
            "Die Basis für Personalisierung ist eingerichtet. Stadt, Lebenssituation und Interessen folgen im nächsten Schritt.",
          email:
            "E-Mail",
          next:
            "Als Nächstes: Profil und Meine Stadt",
          home:
            "Zur Startseite",
        }
      : {
          ...
          title:
            "Akkauntingiz faol",
          description:
            "Personalizatsiya uchun asos tayyor. Keyingi bosqichda shahar, hayot holati va qiziqishlarni sozlaymiz.",
          email:
            "E-mail",
          next:
            "Keyingi: profil va Mening shahrim",
          home:
  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-12 dark:bg-slate-950 sm:px-6">
      <div className="mx-auto max-w-2xl rounded-[2rem] border border-slate-200 bg-white p-6 shadow-xl shadow-slate-900/5 dark:border-slate-800 dark:bg-slate-900 sm:p-8">
        ...
        <Link
          href="/"
          className="mt-8 inline-flex min-h-11 items-center justify-center rounded-2xl border border-slate-300 px-4 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800"
        >
          {copy.home}
        </Link>
      </div>
