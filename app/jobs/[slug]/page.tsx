...
export async function generateMetadata({
  ...
  const guide = getJobGuideBySlug(slug, locale);
...
export default async function JobGuidePage({
  ...
  const relatedGuides = getJobGuides(locale)
  ...
  const copy =
    locale === "uz"
      ? {
          back: "Barcha ish yo‘nalishlari",
          officialBased: "Rasmiy manbaga asoslangan",
          audience: "Kimlar uchun",
          lastVerified: "Oxirgi tekshiruv",
          mainEyebrow: "Asosiy ma’lumotlar",
          mainTitle:
            "Ushbu qo‘llanmada nimalarni bilib olasiz?",
          keywordsEyebrow: "Qidiruv so‘zlari",
          keywordsTitle:
            "Vakansiyani qanday so‘zlar bilan qidirish kerak?",
          planEyebrow: "Amaliy reja",
          planTitle: "Bosqichma-bosqich yo‘riqnoma",
          officialSource: "Rasmiy manba",
          openOfficial: "Rasmiy sahifani ochish",
          warnings: "Muhim ogohlantirishlar",
          disclaimer:
          ...
          relatedTitle: "Sizga foydali bo‘lishi mumkin",
          footer:
      ...
      : {
          back: "Alle Jobthemen",
          officialBased: "Auf offizieller Quelle basierend",
          audience: "Für wen",
          lastVerified: "Zuletzt geprüft",
          mainEyebrow: "Wichtige Informationen",
          mainTitle:
            "Was erfahren Sie in diesem Leitfaden?",
          keywordsEyebrow: "Suchbegriffe",
          keywordsTitle:
            "Mit welchen Begriffen sollten Sie suchen?",
          planEyebrow: "Praktischer Plan",
          planTitle: "Schritt-für-Schritt-Anleitung",
