...
export default function ServiceCard({
  ...
  return (
    <Card
      ...
      className="group relative isolate flex min-h-[370px] overflow-hidden rounded-[2rem] bg-surface animate-fade-in-up"
      style={{
    ...
    >
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-x-0 top-0 h-44 bg-gradient-to-b from-brand/15 via-brand/5 to-transparent opacity-80 transition-opacity duration-500 group-hover:opacity-100"
      />
      ...
      <div className="relative z-10 flex w-full flex-col p-6 sm:p-7">
        <div className="flex items-start justify-between gap-4">
          <div
            aria-hidden="true"
            className="flex size-14 shrink-0 items-center justify-center rounded-2xl border border-brand/15 bg-gradient-to-br from-brand/10 to-accent/10 text-2xl transition-transform duration-300 group-hover:scale-105 group-hover:-rotate-2"
          >
            {service.icon}
          </div>
        ...
        <div className="mt-8">
          <h3
            id={titleId}
            className="text-xl font-bold leading-8 tracking-[-0.025em] text-text-primary sm:text-2xl"
          >
            <Link
              href={href}
        ...
        <div className="mt-auto pt-8">
          <div className="flex items-center justify-between gap-4 border-t border-border-default pt-5">
            <div className="flex min-w-0 items-center gap-2 text-sm text-text-muted">
              <span
                aria-hidden="true"
                className="flex size-8 shrink-0 items-center justify-center rounded-full bg-surface-muted"
              >
