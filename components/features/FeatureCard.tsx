...
export default function FeatureCard({
  ...
  return (
    <article
      className="
        group relative flex h-full min-h-[320px] overflow-hidden
        rounded-[2rem] border border-black/[0.07] bg-white/85 p-6
        shadow-[0_18px_60px_-36px_rgba(15,23,42,0.35)]
        backdrop-blur-xl transition duration-500
        hover:-translate-y-1.5 hover:border-black/[0.12]
        hover:shadow-[0_28px_80px_-36px_rgba(15,23,42,0.45)]
        sm:p-7
        dark:border-white/[0.08] dark:bg-white/[0.045]
        dark:shadow-[0_18px_60px_-36px_rgba(0,0,0,0.8)]
    ...
    >
      <div
        ...
        className={`
          ...
          bg-gradient-to-b ${feature.accentClass}
          opacity-80 transition duration-500 group-hover:opacity-100
        `}
      />
      ...
      <div
        aria-hidden="true"
        className="
          pointer-events-none absolute -right-16 -top-16 size-40
          rounded-full border border-black/[0.05]
      ...
      <div
        aria-hidden="true"
        className="
          pointer-events-none absolute -bottom-24 -left-20 size-48
          rounded-full bg-slate-950/[0.025] blur-2xl
          transition duration-700 group-hover:scale-125
          dark:bg-white/[0.025]
        "
      />
        ...
        <div className="flex items-start justify-between gap-4">
          <div
            className={`
              ...
              ring-1 transition duration-500
        ...
        <div className="mt-8">
          <h3
            className="
              ...
              text-slate-950 sm:text-2xl dark:text-white
            "
          >
            {feature.title}
          </h3>
        ...
        <div className="mt-auto pt-8">
          <Link
            ...
            className="
              ...
              hover:gap-3 hover:text-slate-600
